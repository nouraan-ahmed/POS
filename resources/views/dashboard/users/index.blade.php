...
@section('content')
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td>{{ $user->last_name }}</td>
            <td>{{ $user->email }}</td>
            <td><img src="{{$user->image_path}}" alt="" style="height: 50px;" class="img-thumbnail"></td>
       
            <td>
            @if(auth()->user()->hasPermission('users_update'))
            <a class="btn btn-info btn-sm" href="{{ route('dashboard.edit',$user->id ) }}"><i class="fa fa-edit"></i>@lang('site.edit')</a>
            @else
